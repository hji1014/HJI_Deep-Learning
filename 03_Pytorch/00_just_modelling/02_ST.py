"""
ref : https://github.com/ndb796/Deep-Learning-Paper-Review-and-Practice/blob/master/code_practices/Neural_Image_Captioning_(NIC)_Using_ResNet_101.ipynb
"""
...
decoder = DecoderRNN(embed_size, hidden_size, len_vocab, num_layers).to(device)
