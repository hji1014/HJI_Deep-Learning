...
def main(Pd_l=[0.0, 0.0]):
    ...
    (X_train, Y_train), (X_test, Y_test) = Data_func()      # x_features : 32 * 32 * 3 = 3,072
    model = DNN(X_train.shape[1], Nh_l, Pd_l, Nout)         # Pd_l : dropout 확률 (ex. layers.Dropout(0.25) : 노드의 25% off)
