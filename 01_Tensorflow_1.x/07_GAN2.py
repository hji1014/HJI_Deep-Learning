...
for epoch in range(total_epoch):
    ...
    if epoch == 0 or (epoch + 1) % 10 == 0:
        ...
        samples = sess.run(G,
                           feed_dict={Y: test_labels[:sample_size],
                                      Z: noise})
        ...
        plt.savefig('C:/Users/User/PycharmProjects/py_365/01_Tensorflow_1/GAN_samples_2/{}.png'.format(str(epoch).zfill(3)), bbox_inches='tight')
        plt.close(fig)
